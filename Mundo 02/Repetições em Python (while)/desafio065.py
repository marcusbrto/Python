qntvalor = qntrepeticao = totalvalor = 0 #esses dois é só para declarar a variavel

while True:
    valor = int(input("Digite um valor: "))
    totalvalor += valor #variavel para guardar todos os valores para calcular a media depois
    qntvalor += 1 #serve para declarar as variaveis abaixo e tambem saber a quantidade de valores que foram adicionados para calcular a media depois
    qntrepeticao += 1
    ...
    if conf == "N":
        break
print(f"Você digitou {qntvalor} valores ")
